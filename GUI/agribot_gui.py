...
# ========================FRAME 1================================
bckg = PhotoImage(file="GUI/window 1/background2.png")
lbl_bg = Label(frame1, image=bckg).pack()

btnext = PhotoImage(file="GUI/window 1/next.png")
...
img = PhotoImage(file="GUI/emoji/1.png")
lbl_img = ttk.Label(frame1, image=img, background='#FFFFFF')
lbl_img.place(x=35, y=115)


# ========================FRAME 2================================
bckg2 = PhotoImage(file="GUI/window 2/bg.png")
lbl_bg2 = Label(frame2, image=bckg2).pack()

btnext2 = PhotoImage(file="GUI/window 2/back.png")
...
planted = PhotoImage(file="GUI/window 2/planted.png")
unplanted = PhotoImage(file="GUI/window 2/empty.png")
...
def readSerial():
    while True:
        ...
        if c == b'\n':
            ...
            # ubah dynamic image
            img = PhotoImage(file="GUI/emoji/" + p_status + ".png")
