...
def TextToSpeech(cTemp, lux, humidity, moisture):
    try:
        ...
        phrase = "Selamat {}, Kondisi Suhu saat ini adalah {} derajat Celcius, Dan kelembapan Tanah sebesar {} Persen, Kelembapan Udara sebesar {} persen.".format(waktu, int(cTemp), int(humidity), int(moisture))     
